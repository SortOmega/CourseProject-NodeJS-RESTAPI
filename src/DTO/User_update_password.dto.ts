...
const UpdatePasswordDTOSchema = Type.Object(
  {
    oldPassword: password_userDTOSchema,
    newPassword: password_userDTOSchema,
  },
  {
...
const validateUserSchema = ajv.compile(UpdatePasswordDTOSchema);

const UserUpdatePasswordDTO = (
  Solicitud: Request,
  Respuesta: Response,
